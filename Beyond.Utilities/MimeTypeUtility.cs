...
public static class MimeTypeUtility
{
    ...
    public static void AddOrUpdate(string fileExtension, string mime)
    {
        if (!fileExtension.StartsWith('.'))
            fileExtension = $".{fileExtension}";

        MimeTypeMap.Value[fileExtension] = mime;
    }

    public static string GetFileExtension(string mime)
    {
        var m = MimeTypeMap.Value.FirstOrDefault(x => x.Value.Contains(mime)).Value;
        return m;
    }
    ...
    public static string GetMimeType(string fileExtension)
    {
        if (!fileExtension.StartsWith('.'))
            fileExtension = $".{fileExtension}";
        var fe = MimeTypeMap.Value.FirstOrDefault(x => x.Key.Contains(fileExtension)).Key;
        return fe;
    }
}